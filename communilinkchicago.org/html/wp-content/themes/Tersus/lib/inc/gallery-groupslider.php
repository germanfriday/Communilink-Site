<?php 
	...
	echo '<div id="group-slider-main" class="gallery-wrap group-slider main row'. $NV_galleryclass .' nv-skin clearfix '. $NV_verticalslide. '" data-groupslider-fx="'. $NV_effect .'">';
	echo '<div class="group-slider main '. $NV_imgalign .'" '. $NV_vertheight .'>';
