<?php
	...
	elseif( $NV_videotype=="jwp" )
	{
        ...
        { 
            $jwplayer_height = $jwplayer_height="'height':'". ceil( $NV_imgwidth / "1.595" ) ."',"; $NV_imgheight=ceil( $NV_imgwidth / "1.595" ); 
        }
        ...
        {
            $jwplayer_height = get_option('jwplayer_height');
        } 
		...
		elseif( get_option('jwplayer_skinpos') )
		{
			$controlbar = get_option('jwplayer_skinpos');
		} else 
		{
			$controlbar = 'over';
		}
		...
		// skin
		$skin = ( get_option('jwplayer_skin') !='' ? get_option('jwplayer_skin') : '' );			
		...
		data-jw-icons="'. $icons .'" 
		data-jw-skin="'. $skin .'" 
		data-jw-swfsrc="'. get_option('jwplayer_swf') .'" 
