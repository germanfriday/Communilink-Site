...
if(!$NV_videotype) { ?>
<Image Source="<?php echo $NV_imagepath . dyn_getimagepath($imagepath); ?>" Title="<?php echo $NV_posttitle; ?>">
...
<Flash Source="<?php echo $NV_movieurl; ?>" Title="<?php echo $NV_posttitle; ?>">
      <Image Source="<?php echo $NV_imagepath . dyn_getimagepath($imagepath); ?>" />
</Flash>
