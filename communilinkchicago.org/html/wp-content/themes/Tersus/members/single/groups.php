...
<div class="create-group" align="right">
	<?php _e( 'Groups Directory', 'buddypress' ) ?><?php if ( is_user_logged_in() ) : ?>
    <div class="button-wrap" style="margin-left:20px;">
        <div class="grey-lite button ">
            <a href="<?php echo bp_get_root_domain() . '/' . BP_GROUPS_SLUG . '/create/' ?>"><?php _e( 'Create a Group', 'buddypress' ) ?></a>
        </div>
    </div><?php endif; ?>
</div>
<?php
