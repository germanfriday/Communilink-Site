...
/**
 * Functions of Tersus bbPress Theme
 *
 * @package bbPress
 * @subpackage Tersus_bbPress
 * @since bbPress (r3732)
 */
...
class BBP_Default extends BBP_Theme_Compat {
	...
	public function before_main_content() {
		...
		if( empty( $NV_layout ) ) $NV_layout=get_option("buddylayout");
	...
	public function enqueue_styles() {
		...
		// LTR or RTL
		$file = is_rtl() ? 'css/bbpress-rtl.css' : 'stylesheets/bbpress.css';
