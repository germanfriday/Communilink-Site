 ...
 */
	...
	if ( bp_has_forum_topics( bp_ajax_querystring( 'forums' ) ) ) : ?>
					...
					while ( bp_forum_topics() ) : bp_the_forum_topic(); ?>
						...
						<tr class="<?php bp_the_topic_css_class(); ?>">
							...
							<td class="td-title">
								...
								<a class="topic-title ntd" href="<?php bp_the_topic_permalink(); ?>" title="<?php bp_the_topic_title(); ?> - <?php _e( 'Permalink', 'buddypress' ); ?>"><?php bp_the_topic_title(); ?></a>
		...
		<div id="message" class="info"><p><?php _e( 'Sorry, there were no forum topics found.', 'buddypress' ); ?></p></div><?php
