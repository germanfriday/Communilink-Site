							...
							<?php
								...
								elseif ( is_category() ) :
									...
									$out = '<blockquote>';
										...
										$out .= '<span class="icon16 fr" style="margin:3px 0 0 0; background-image:url(' . get_bloginfo('template_url') . '/images/icons/16/led-icons/feed_document.png) !important;"><a class="tooltip" style="color:#ff7700;" href="' . get_bloginfo('home') . '/?cat=' . $category[0]->cat_ID . '&feed=rss2" title="' . __('Subscribe to this category','pandathemes') . '">RSS</a></span>';
