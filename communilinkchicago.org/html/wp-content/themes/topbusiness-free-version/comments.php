			...
			<form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
				...
				<?php
					...
					<div class="rating">
						...
						<div id="rstars">
							<div class="tooltip" title="<?php _e('Very bad','pandathemes') ?>">
								</div><div class="tooltip" title="<?php _e('No good','pandathemes') ?>">
								</div><div class="tooltip" title="<?php _e('So-so','pandathemes') ?>">
								</div><div class="tooltip" title="<?php _e('Good','pandathemes') ?>">
								</div><div class="tooltip" title="<?php _e('Excellent','pandathemes') ?>">
							</div>
						</div>
					</div>
