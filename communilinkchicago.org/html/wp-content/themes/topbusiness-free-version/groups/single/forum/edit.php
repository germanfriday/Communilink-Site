	...
	if ( bp_has_forum_topic_posts() ) : ?>
		...
		<form action="<?php bp_forum_topic_action(); ?>" method="post" id="forum-topic-form" class="standard-form">
			...
			<div id="topic-meta">
				...
				<h3><span class="f16"><?php _e( 'Edit:', 'buddypress' ); ?></span> <br><?php bp_the_topic_title(); ?></h3>
		...
		<div id="message" class="info"><p><?php _e( 'This topic does not exist.', 'buddypress' ); ?></p></div><?php
