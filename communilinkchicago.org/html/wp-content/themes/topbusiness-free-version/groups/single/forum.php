				...
				<div id="new-topic-post">
					...
					<?php
						...
						if ( bp_groups_auto_join() && !bp_group_is_member() ) : ?>
							...
							<p><?php _e( 'You will auto join this group when you start a new topic.', 'buddypress' ); ?></p><?php
					...
					<div class="submit"><input type="submit" name="submit_topic" id="submit" value="<?php _e( 'Post Topic', 'buddypress' ); ?>" /></div>
