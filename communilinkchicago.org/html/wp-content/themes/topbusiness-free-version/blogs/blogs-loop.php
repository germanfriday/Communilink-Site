 ...
 */
			...
			<?php
				...
				while ( bp_blogs() ) : bp_the_blog(); ?>
					...
					<li>
						...
						<div class="item-avatar"><a href="<?php bp_blog_permalink(); ?>"><?php bp_blog_avatar( 'type=thumb' ); ?></a></div>
			
						<div class="item">

							<div class="item-title"><a class="ntd" href="<?php bp_blog_permalink(); ?>"><?php bp_blog_name(); ?></a></div>
	...
	<?php else: ?>
		...
		<div id="message" class="info"><p><?php _e( 'Sorry, there were no sites found.', 'buddypress' ); ?></p></div>
