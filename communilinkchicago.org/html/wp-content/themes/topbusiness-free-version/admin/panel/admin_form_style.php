		...
		<table><tr>
			...
			<td>
				...
				<div class="tmpl_radio">
					...
					<input type="radio" value="1" name="style" id="style_1s" checked="checked" />
				...
				<?php
					...
					foreach ($arr as $value) {
						$out = '<div class="tmpl_radio">';
							$out .= '<label disabled="disabled" title="Available for FULL version only" class="lable-img" for="style_'.$value.'s"><img src="'.$template_url.'/admin/graphics/styles/'.$value.'.png" width="40" height="40"></label>';
	
							$ch = '';
							$out .= '<input disabled="disabled" title="Available for FULL version only" type="radio" value="'.$value.'" name="style" id="style_'.$value.'s" '.$ch.' />';
