...
function pagenavi_init() {
	...
	$pagenavi_options['pages_text'] = __('Page %CURRENT_PAGE% of %TOTAL_PAGES%','pandathemes');
	$pagenavi_options['current_text'] = '%PAGE_NUMBER%';
	$pagenavi_options['page_text'] = '%PAGE_NUMBER%';
	$pagenavi_options['first_text'] = __('&laquo; First','pandathemes');
	$pagenavi_options['last_text'] = __('Last &raquo;','pandathemes');
	$pagenavi_options['next_text'] = __('&raquo;','pandathemes');
	$pagenavi_options['prev_text'] = __('&laquo;','pandathemes');
	$pagenavi_options['dotright_text'] = __('...','pandathemes');
	$pagenavi_options['dotleft_text'] = __('...','pandathemes');
