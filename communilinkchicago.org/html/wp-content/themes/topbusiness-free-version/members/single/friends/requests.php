<?php
	...
	if ( bp_has_members( 'include=' . bp_get_friendship_requests() ) ) : ?>
			...
			<?php
				...
				while ( bp_members() ) : bp_the_member(); ?>
					...
					<li id="friendship-<?php bp_friend_friendship_id(); ?>">
						...
						<div class="item-avatar"><a href="<?php bp_member_link(); ?>"><?php bp_member_avatar(); ?></a></div>
		...
		<div id="message" class="info"><p><?php _e( 'You have no pending friendship requests.', 'buddypress' ); ?></p></div><?php
