...
<?php
	...
	if ( !(int)bp_get_option( 'bp-disable-avatar-uploads' ) ) : ?>
			...
			<?php
				...
				if ( 'upload-image' == bp_get_avatar_admin_step() ) :
					...
					if ( bp_get_user_has_avatar() ) : ?>
						...
						<p><a class="button edit" href="<?php bp_avatar_delete_link(); ?>" title="<?php _e( 'Delete Avatar', 'buddypress' ); ?>"><?php _e( 'Delete My Avatar', 'buddypress' ); ?></a></p><?php
		...
		<p><?php _e( 'Your avatar will be used on your profile and throughout the site. To change your avatar, please create an account with <a href="http://gravatar.com">Gravatar</a> using the same email address as you used to register with this site.', 'buddypress' ); ?></p><?php
