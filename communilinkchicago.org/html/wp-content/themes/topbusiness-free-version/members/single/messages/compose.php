<form action="<?php bp_messages_form_action('compose'); ?>" method="post" id="send_message_form" class="standard-form" role="main">
	...
	<?php
		...
		if ( is_super_admin() ) : ?>
			...
			<input type="checkbox" id="send-notice" name="send-notice" value="1" /><?php

			_e( "This is a notice to all users.", "buddypress" );
	...
	<div class="submit"><input type="submit" value="<?php _e( "Send Message", 'buddypress' ); ?>" name="send" id="send" /></div>
